...
fr.JavaRandom = cc.Class.extend({
    ...
    saveSeed: function () {
        fr.UserData.setNumberWithCrypt(KeyStorage.RANDOM_SEED + userMgr.getData().uId, this.seed.valueOf());
    }
});
...
fr.setRandomSeed = function (seed) {
    fr.UserData.setNumberWithCrypt(KeyStorage.RANDOM_SEED + userMgr.getData().uId.toString(), seed);
