...
fr.Localization = cc.Class.extend(
    {
        ...
        loadDefaultLanguage: function () {
            ...
            // chi dung khi test 2 ban th va ph
            // if(fr.platformWrapper.getPackageName() == "com.zps.match3_ph"){
            //     defaultLangID = "ph"
            // }else{
            //     defaultLangID = "th"
            // }
            this.setCurrentLanguage(defaultLangID);
            cc.log("defaultLangID " + defaultLangID)
        },
        ...
        _isHaveText: function (key) {
            return key in this._localizedStrings;
        },
...
fr.Localization.hasText = function (key) {
    return fr.Localization.getInstance()._isHaveText(key);
};
...
fr.Localization.getLang = function () {
    return fr.Localization.getInstance().getCurrentLanguageCode()[0];
};