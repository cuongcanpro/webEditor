...
Utility.getResourcesCountryCode = function () {
    ...
    if(fr.Localization.getLang() == langCode.VN){
        return langCode.VN;
    }
    else if(fr.Localization.getLang() == langCode.GLOBAL){
        return langCode.GLOBAL;
    }
    // else if(fr.Localization.getLang() == langCode.PHIL){
    //     return langCode.PHIL;
    // }
    // else if(fr.Localization.getLang() == langCode.THAI){
    //     return langCode.THAI;
    // }
    return langCode.GLOBAL;
}