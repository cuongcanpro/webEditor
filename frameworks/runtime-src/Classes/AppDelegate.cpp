...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	fr::FrameworkDelegate::getInstance()->setFolderAssets(ConfigReader::getInstance()->updateFolder);
	...
	glview->setDesignResolutionSize(ConfigReader::getInstance()->resolutionWidth, ConfigReader::getInstance()->resolutionHeight, static_cast<ResolutionPolicy>(ConfigReader::getInstance()->resolutionPolicy));

	// search path
	ConfigReader::getInstance()->addSearchPath(fr::NativeService::getFolderUpdateAssets());
